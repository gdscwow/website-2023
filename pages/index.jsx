  ...
  if (isLive) {
    ...
    return (
      <>
        ...
        <div id="home" className='max-md:overflow-hidden flex flex-col justify-center items-center min-w-screen min-h-screen font-GoogleSans'>
          <Navbar />
          <Hero />
          <About />
          <Team />
        ...
        <footer className='max-md:gap-5 max-md:p-5 h-96  min-w-screen p-16 bg-translucent grid grid-cols-3 gap-20 font-GoogleSans'>
          <div className='h-full w-full flex flex-col'>
            <Image loading='lazy' src="/Assets/Images/Logo.png" className='animate-spin-slow max-md:h-16 max-md:w-16' height={100} width={100} alt="wow" />
            <p className='mt-5 text-blackish text-2xl max-md:text-lg'>Google Developers Student Clubs<br />WOW 2023</p>
            <a href='mailto:eamil@gmail.com' className='mt-10 max-md:mt-16 max-md:text-lg text-blackish text-2xl'>email@gmail.com</a>
          </div>
          <div className='h-full w-full flex flex-col'>
            <p className='mt-5 text-black text-3xl max-md:text-lg'>Navigation</p>
            <ul className='mt-10 text-2xl max-md:text-lg text-blackish'>
              <li className="mb-2 cursor-pointer max-md:mb-1 hover:text-black transition ease-in-out duration-300"><Link activeClass="active"
                to="about"
                smooth={true}
              ...
              }} className="cursor-pointer max-md:mb-1 hover:text-black transition ease-in-out duration-300">Privacy Policy</li>
            </ul>
          </div>
          <div className='h-full w-full flex flex-col'>
            <p className='mt-5 text-black text-3xl max-md:text-lg'>Follow Us</p>
            <p className='mt-2 text-blackish text-lg max-md:mt-10'>Follow us for latest updates!</p>
