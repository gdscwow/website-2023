...
export default function About() {
    return(
        <div id='about' className="min-h-screen w-full flex justify-evenly items-center flex-col bg-about bg-cover">
            <h1 data-aos="fade-up" className="text-6xl inline-flex justify-center items-center text-lightblack">What is <Image src="/Assets/Images/wow.svg" className="ml-5 mt-3 inline-flex" height={250} width={250} alt="wow"/></h1>
