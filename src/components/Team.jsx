export default function Team() {
    return (
        <div id="team" className="min-h-screen w-full bg-team bg-cover flex flex-col justify-evenly items-center">
            <h1 data-aos="fade-up" className="text-6xl font-semibold flex">Our <p className="ml-5 text-blue-500">T</p><p className="text-red-500">e</p><p className="text-green-500">a</p><p className="text-yellow-500">m</p></h1>
